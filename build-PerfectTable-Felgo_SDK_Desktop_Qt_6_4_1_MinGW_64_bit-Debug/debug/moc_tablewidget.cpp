...
#include <memory>
#include "../../PerfectTable/tablewidget.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_TableWidget_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_TableWidget_t qt_meta_stringdata_TableWidget = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_TableWidget[] = {
...
Q_CONSTINIT const QMetaObject TableWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_TableWidget.offsetsAndSizes,
    qt_meta_data_TableWidget,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_TableWidget_t,
        // Q_OBJECT / Q_GADGET
