...
#include "Item.h"
QString strTitleNames[static_cast<size_t>(TITLES::TITLE_SIZE)] = { "Артикул", "Наименование", "Закупочная стоимость [руб]", "Цена [руб]", "Размещение на складе", "Остаток на складе [шт] ", "Срок годности", "Номер партии" };
