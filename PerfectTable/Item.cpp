...
#include "Item.h"
QString strTitleNames[static_cast<size_t>(TITLES::TITLE_SIZE)] = { "Артикул", "Наименование", "Закупочная стоимость", "Цена", "Размещение на складе", "Остаток на складе", "Срок годности", "Номер партии" };
