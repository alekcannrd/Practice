...
MyChangeMenu::MyChangeMenu(List *q, Item* item, bool* accepted, QDialog *parent) :
...
void MyChangeMenu::OnRefuse()
{
    close();
}

void MyChangeMenu::createButtons()
{
